  ...
  render() {
    return (
      ...
      <form ref={this.form} onSubmit={this.sendEmail} className='flex flex-col max-w-[600px] w-full'>
        ...
        <input placeholder='Name' className='border-2 bg-slate-200 border-gray-300 px-4 py-2 rounded-full' type="text" name="user_name" />
       
        <input placeholder='Email' className='border-2 bg-slate-200 border-gray-300 px-4 py-2 rounded-full my-4' type="email" name="user_email" />
       
        <textarea placeholder='Message' className='border-2 bg-slate-200 border-gray-300 rounded-lg px-4 py-2' name="message" rows="10" />
